...
const ScrollContent = ({ currentIndex, handleNext, handlePrevious }) => {
  ...
  return (
    <div className="flex flex-col gap-2 justify-around items-center md:items-start md:ml-[calc(10%-10px)] h-screen w-screen">
      <div className="hidden md:flex mt-5 z-50 flex-row items-center justify-between px-2 py-2 w-3/5 rounded-full bg-[#2a2a2a]">
      ...
      <div className="md:hidden z-50 mt-24 flex flex-row items-center justify-between gap-2 px-3 py-2 w-5/6 rounded-full bg-[#2a2a2a]">
