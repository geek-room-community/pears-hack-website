    ...
    const prizeData = [
        {
            ...
            title: "AIRPODS",
            image: [airpods],
            class: "xl:w-40 xl:h-40 w-20 h-20",
            description: "AirPods",
        },
        {
            id: 2,
            title: "CASH PRIZE",
            image: [],
            class: "xl:w-40 xl:h-40 w-24 h-24",
        ...
        },
        {
            ...
            title: "SAMSUNG TAB",
            image: [tablet],
            class: "xl:w-40 xl:h-40 w-16 h-16",
        ...
        },
        {
            ...
            title: "JETBRAINS ID",
            image: [jetbrains],
            class: "xl:w-32 xl:h-32 w-16 h-12",
        ...
        },
        {
            ...
            image: [amazon],
            class: "xl:w-40 xl:h-24 w-24 h-16",
    ...
    return (
        <div className='mb-[24vh] md:mb-4 h-fit overflow-y-auto scrollbar-hide'>
            <div className='w-full h-full grid grid-cols-2 gap-2 lg:grid-cols-3 md:gap-x-4 lg:gap-x-6 lg:gap-y-4'>
                {prizeData.map((prize) => (
                    <div key={prize.id} className='w-[170px] h-full md:w-[215px] md:h-52 xl:w-[250px] xl:h-64 py-4 lg:py-8 bg-[#1A1A1A] rounded-3xl text-white flex flex-col items-center justify-between '>
                        <div className='flex flex-row items-center justify-center'>
                            {prize.image.length > 0 ? prize.image.map((image) => (
                                <img src={image} alt={prize.title} className={`${prize.class} object-contain`} />
                            )) : <p className='text-white text-2xl md:text-5xl xl:text-6xl font-bold -tracking-[0.06em] pt-6 xl:pt-12'>{prize.description}</p>}
                        </div>
