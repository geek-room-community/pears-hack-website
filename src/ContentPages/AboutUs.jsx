...
const AboutUs = () => {
  ...
  return (
    <div className="mx-auto md:ml-0 max-w-[900px] bg-[#2a2a2a] py-2 px-3 xl:px-6 mb-[18vh] md:mb-10 rounded-[2.3rem] text-white w-[80%] md:w-[95%] lg:w-[90%] max-h-[60vh] md:max-h-[80vh] overflow-y-auto scrollbar-hide">
