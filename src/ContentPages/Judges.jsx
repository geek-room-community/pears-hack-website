...
//           <JudCard key={`${mentor.name}-${index}`} mentor={mentor} />
//         ))}
//       </div>
//     </div>
//   );
...
//           <Carousel mentors={jud} direction="right" />
//         </div>
//       </div>
//     </section>
//   );
