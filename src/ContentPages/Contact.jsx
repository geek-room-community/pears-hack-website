...
const Contact = () => {
  return (
    <div className="bg-[#2A2A2A] mb-20 md:mb-10 shadow-lg p-6 rounded-3xl flex flex-col justify-center gap-1 md:gap-5 w-11/12 md:w-full md:max-w-md mx-auto h-auto">
